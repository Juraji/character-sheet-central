...
class RegisteredClientsConfiguration {
    ...
    fun registeredClientRepository(
        ...
        val clients = objectMapper
            ...
            .map { configureClient(it, passwordEncoder) }

        return InMemoryRegisteredClientRepository(clients)
    }

    private fun configureClient(c: Map<String, Any>, passwordEncoder: PasswordEncoder): RegisteredClient =
        RegisteredClient
            .withId(c["id"] as String)
            .clientId(c["clientId"] as String)
            .clientName(c["clientName"] as String)
            .clientSecret(passwordEncoder.encode(c["clientSecret"] as String))
